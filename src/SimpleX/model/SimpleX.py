...
class SimpleX1(MatchingModel):
    def __init__(self, 
        ...
        super(SimpleX, self).__init__(feature_map, 
                                      ...
                                      **kwargs)
        self.similarity_score = similarity_score   #'cosine'
        self.embedding_dim = embedding_dim         # 64
        self.user_id_field = user_id_field         # 'user_id'  : col name
        self.user_history_field = user_history_field  # 'user_history'
        ...
        self.enable_bias = enable_bias  # False
        if self.enable_bias:
        ...
        self.dropout = nn.Dropout(net_dropout)    # 0.1
